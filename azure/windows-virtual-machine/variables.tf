...
variable "autoshutdown_time" {
  description = "Time in 24h to automatically shut down the virtual machine."
  type        = string
  default     = "2200"
}

variable "autoshutdown_timezone" {
  description = "Timezone used when determining when to shut down the virtual machine."
  type        = string
  default     = "UTC"
}
