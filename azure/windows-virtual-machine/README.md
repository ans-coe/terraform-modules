...
| <a name="input_autoshutdown_time"></a> [autoshutdown\_time](#input\_autoshutdown\_time) | Time in 24h to automatically shut down the virtual machine. | `string` | `"2200"` | no |
| <a name="input_autoshutdown_timezone"></a> [autoshutdown\_timezone](#input\_autoshutdown\_timezone) | Timezone used when determining when to shut down the virtual machine. | `string` | `"UTC"` | no |
