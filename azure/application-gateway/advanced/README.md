...
| <a name="input_key_vault_public_access"></a> [key\_vault\_public\_access](#input\_key\_vault\_public\_access) | Disable Key Vault Public Access - Should only be set if setting up Private Endpoint | `bool` | `true` | no |
