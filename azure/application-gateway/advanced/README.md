...
| <a name="input_key_vault_public_access"></a> [key\_vault\_public\_access](#input\_key\_vault\_public\_access) | Enable Key Vault Public Access - Should only be set false if setting up Private Endpoint. Only applies to Key Vault created within Module. | `bool` | `true` | no |
