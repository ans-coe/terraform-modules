...
| <a name="input_create_flow_log_log_analytics_workspace"></a> [create\_flow\_log\_log\_analytics\_workspace](#input\_create\_flow\_log\_log\_analytics\_workspace) | Create a Log Analytics Workspace for Flow Logs Analytics. | `bool` | `false` | no |
| <a name="input_create_flow_log_storage_account"></a> [create\_flow\_log\_storage\_account](#input\_create\_flow\_log\_storage\_account) | Create a Storage Account for Flow Logs. | `bool` | `false` | no |
