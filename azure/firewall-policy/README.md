...
|------|-------------|------|---------|:--------:|
| <a name="input_dns"></a> [dns](#input\_dns) | Whether to enable DNS proxy on Firewalls attached to this Firewall Policy and a list of custom DNS Server IPs | <pre>object({<br>    servers       = optional(list(string))<br>    proxy_enabled = optional(bool)<br>  })</pre> | n/a | yes |
