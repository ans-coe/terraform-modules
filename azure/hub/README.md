...
| <a name="input_private_endpoint_private_dns_zones"></a> [private\_endpoint\_private\_dns\_zones](#input\_private\_endpoint\_private\_dns\_zones) | A list of private endpoint private dns zones to configure | <pre>object({<br>    "privatelink.adf.azure.com"                     = optional(bool, true)<br>    "privatelink.afs.azure.net"                     = optional(bool, true)<br>    "privatelink.agentsvc.azure-automation.net"     = optional(bool, true)<br>    "privatelink.analysis.windows.net"              = optional(bool, true)<br>    "privatelink.api.azureml.ms"                    = optional(bool, true)<br>    "privatelink.azconfig.io"                       = optional(bool, true)<br>    "privatelink.azure-api.net"                     = optional(bool, true)<br>    "privatelink.azure-automation.net"              = optional(bool, true)<br>    "privatelink.azure-devices-provisioning.net"    = optional(bool, true)<br>    "privatelink.azure-devices.net"                 = optional(bool, true)<br>    "privatelink.azurecr.io"                        = optional(bool, true)<br>    "privatelink.azurehdinsight.net"                = optional(bool, true)<br>    "privatelink.azurehealthcareapis.com"           = optional(bool, true)<br>    "privatelink.azurestaticapps.net"               = optional(bool, true)<br>    "privatelink.azuresynapse.net"                  = optional(bool, true)<br>    "privatelink.batch.azure.com"                   = optional(bool, true)<br>    "privatelink.azurewebsites.net"                 = optional(bool, true)<br>    "privatelink.blob.core.windows.net"             = optional(bool, true)<br>    "privatelink.cassandra.cosmos.azure.com"        = optional(bool, true)<br>    "privatelink.cognitiveservices.azure.com"       = optional(bool, true)<br>    "privatelink.database.windows.net"              = optional(bool, true)<br>    "privatelink.datafactory.azure.net"             = optional(bool, true)<br>    "privatelink.dev.azuresynapse.net"              = optional(bool, true)<br>    "privatelink.developer.azure-api.net"           = optional(bool, true)<br>    "privatelink.dfs.core.windows.net"              = optional(bool, true)<br>    "privatelink.dicom.azurehealthcareapis.com"     = optional(bool, true)<br>    "privatelink.digitaltwins.azure.net"            = optional(bool, true)<br>    "privatelink.directline.botframework.com"       = optional(bool, true)<br>    "privatelink.documents.azure.com"               = optional(bool, true)<br>    "privatelink.eventgrid.azure.net"               = optional(bool, true)<br>    "privatelink.file.core.windows.net"             = optional(bool, true)<br>    "privatelink.gremlin.cosmos.azure.com"          = optional(bool, true)<br>    "privatelink.guestconfiguration.azure.com"      = optional(bool, true)<br>    "privatelink.his.arc.azure.com"                 = optional(bool, true)<br>    "privatelink.kubernetesconfiguration.azure.com" = optional(bool, true)<br>    "privatelink.managedhsm.azure.net"              = optional(bool, true)<br>    "privatelink.mariadb.database.azure.com"        = optional(bool, true)<br>    "privatelink.mongo.cosmos.azure.com"            = optional(bool, true)<br>    "privatelink.media.azure.net"                   = optional(bool, true)<br>    "privatelink.monitor.azure.com"                 = optional(bool, true)<br>    "privatelink.mysql.database.azure.com"          = optional(bool, true)<br>    "privatelink.notebooks.azure.net"               = optional(bool, true)<br>    "privatelink.ods.opinsights.azure.com"          = optional(bool, true)<br>    "privatelink.oms.opinsights.azure.com"          = optional(bool, true)<br>    "privatelink.pbidedicated.windows.net"          = optional(bool, true)<br>    "privatelink.postgres.database.azure.com"       = optional(bool, true)<br>    "privatelink.prod.migration.windowsazure.com"   = optional(bool, true)<br>    "privatelink.purview.azure.com"                 = optional(bool, true)<br>    "privatelink.purviewstudio.azure.com"           = optional(bool, true)<br>    "privatelink.queue.core.windows.net"            = optional(bool, true)<br>    "privatelink.redis.cache.windows.net"           = optional(bool, true)<br>    "privatelink.redisenterprise.cache.azure.net"   = optional(bool, true)<br>    "privatelink.search.windows.net"                = optional(bool, true)<br>    "privatelink.service.signalr.net"               = optional(bool, true)<br>    "privatelink.servicebus.windows.net"            = optional(bool, true)<br>    "privatelink.siterecovery.windowsazure.com"     = optional(bool, true)<br>    "privatelink.sql.azuresynapse.net"              = optional(bool, true)<br>    "privatelink.table.core.windows.net"            = optional(bool, true)<br>    "privatelink.table.cosmos.azure.com"            = optional(bool, true)<br>    "privatelink.tip1.powerquery.microsoft.com"     = optional(bool, true)<br>    "privatelink.token.botframework.com"            = optional(bool, true)<br>    "privatelink.uks.backup.windowsazure.com"       = optional(bool, true)<br>    "privatelink.uksouth.azmk8s.io"                 = optional(bool, true)<br>    "privatelink.uksouth.kusto.windows.net"         = optional(bool, true)<br>    "privatelink.vaultcore.azure.net"               = optional(bool, true)<br>    "privatelink.web.core.windows.net"              = optional(bool, true)<br>    "privatelink.webpubsub.azure.com"               = optional(bool, true)<br>  })</pre> | n/a | yes |
